        ...
        <?= $commentContent; ?>
                <form action="addComment.php?id=<?= $id ?>&comment=<?= $comment['id'] ?>&action=reply" method="post" class="flex">
                    <div class="comment-container">
                        ...
                        <textarea name="reply-comment" id="reply-comment"></textarea>
                    </div>

                    <button type="submit" class=" send-edit-btn ml-1 " id="send-edit-comment-btn"><svg width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
